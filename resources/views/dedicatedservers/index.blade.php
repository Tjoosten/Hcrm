...
<div class="form-group">
 <label for="created"  class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-3">Created</label>
  <div class="input-group col-lg-9 col-md-9 col-sm-9 col-xs-9">
     <input type="text" id="createdAfter" name="created" class="form-control">
           <div class="input-group-addon">
         <span class="help-inline">
          <i class="glyphicon glyphicon-question-sign" data-toggle="tooltip"  data-placement="bottom"  data-container="body" title="Crreated at"></i>
         </span>
        </div>
   </div>
</div>
...
<div class="form-group">
 <label for="updated" class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-3">Updated</label>
 <div class="input-group col-lg-9 col-md-9 col-sm-9 col-xs-9">
    <input type="text" id="updated" name="updated"  class="form-control">
            <div class="input-group-addon">
         <span class="help-inline">
          <i class="glyphicon glyphicon-question-sign" data-toggle="tooltip"  data-placement="bottom"  data-container="body" title="Updated at"></i>
         </span>
        </div>
 </div>
 </div>
